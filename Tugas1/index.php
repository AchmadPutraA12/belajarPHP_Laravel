  ...
  <body>
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <nav
            class="navbar navbar-toggleable-sm navbar-light bg-light static-top"
          >
            <button
            ...
            <a
              class="navbar-brand"
              href="https://labinformatika.itats.ac.id/informasi?lab=rpl"
              target="_blank"
              ><img src="/images/rpl.png" style="height: 40px"
            /></a>
            <div
            ...
            >
              <ul class="navbar-nav ml-md-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index2.html">Portofolio</a>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="text-center">
            ...
            <br />
            <p>
              hallo, nama saya Achmad Putra Arifky saya berasal dari Surabaya
