...
<body>
    ...
    <form action="produk_controller.php" method="POST">
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text1" name="kode" type="text" class="form-control" required="required" value="<?= $produk['kode'] ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text" name="harga_beli" type="text" class="form-control" value="<?= $produk['harga_beli'] ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <!-- <div class="form-group row">
            ...
            <div class="col-8">
                <input id="fileToUpload" name="fileToUpload" type="file" accept="image/*" class="form-control" placeholder="Maksimal File 1 MB">
            </div>
        </div> -->
        <div class="form-group row">
