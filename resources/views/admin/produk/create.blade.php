...
@section('content')
    ...
    <form method="POST" action="{{ url('admin/produk/store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label for="text4" class="col-4 col-form-label">Min Stok</label>
            <div class="col-8">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text4" name="foto" type="file"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <select id="select" name="jenis_produk_id"
                    class="custom-select @error('jenis_produk_id') is-invalid @enderror">
